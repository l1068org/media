...
public final class PsExtractor implements Extractor {
      ...
      if (payloadReader == null) {
        ...
        if (streamId == PRIVATE_STREAM_1) {
          ...
          elementaryStreamReader =
              new H262Reader(
                  MimeTypes.VIDEO_PS, isMpeg1 ? MimeTypes.VIDEO_MPEG : MimeTypes.VIDEO_MPEG2);
  ...
  private static final class PesReader {
     ...
     *
     * <p>MPEG-1 PES headers differ from MPEG-2: they use stuffing bytes (0xFF), an optional STD
     * buffer field, and a different PTS/DTS encoding without a fixed-length header.
     */
