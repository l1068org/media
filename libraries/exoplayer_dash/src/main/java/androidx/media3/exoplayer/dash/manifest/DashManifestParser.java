...
public class DashManifestParser extends DefaultHandler
  ...
  protected SegmentList parseSegmentList(
    ...
    long presentationTimeOffset =
        parseLong(
            xpp, "presentationTimeOffset", parent != null ? parent.presentationTimeOffset : 0);
    long duration =
        parseTicks(xpp, "duration", parent != null ? parent.duration : C.TIME_UNSET, timescale);
  ...
  protected static long parseTicks(
      XmlPullParser xpp, String name, long defaultValue, long timescale) {
    String value = xpp.getAttributeValue(null, name);
    if (value == null) {
      return defaultValue;
    }
    ...
    return value.startsWith("P") || value.startsWith("-P")
        ? Util.scaleLargeTimestamp(Util.parseXsDuration(value), timescale, C.MILLIS_PER_SECOND)
